...
<body>
    ...
    <header id="header">
    <div class="headerImg"> 
        <img src="images/acu4.jpg" alt="" srcset="">
    </div>
    ...
    <!--  Start The Navbar  -->
        <nav>
            <div class="container"> 
                ...
                <!-- The button of Night Mode  -->
                <button class="nightModeBtn" onclick="NightMode()">
                    <!-- The svg that contains the icon of the button  -->
